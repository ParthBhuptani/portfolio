  ...
  return (
    <Reveal delay={i * 0.05}>
      <article
        ...
        className="group relative flex flex-col justify-between h-full overflow-hidden rounded-2xl border p-5 transition-[transform,box-shadow,border-color] duration-300 hover:-translate-y-1 hover:scale-[1.015] hover:shadow-xl hover:shadow-accent/5 hover:border-accent/40 backdrop-blur-lg bg-surface/30"
      >
