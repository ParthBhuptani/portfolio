...
export function CommandPalette({
  ...
  id: "action-theme",
  category: "actions",
  title: (theme ?? "dark") === "dark" ? "Switch to Light Theme" : "Switch to Dark Theme",
  subtitle: (theme ?? "dark") === "dark" ? "Go light mode" : "Go dark mode",
  icon: (theme ?? "dark") === "dark" ? <Sun size={16} /> : <Moon size={16} />,
  action: () => {
